function LargePunch() 
{
	...
	scrProcessAttacks(punchLargeSpr, sFighterLargePunchHB, punchLarge.knockback_x, punchLarge.knockback_y,
...
function airLargePunch() 
{
	scrProcessAttacks(airPunchLargeSpr, sFighterAirLargePunchHB, AirLarge.knockback_x, AirLarge.knockback_y,
...
function crouchLargePunch()
{
	scrProcessAttacks(crouchPunchLargeSpr, sFighterCrouchPunchHB, CrouchLarge.knockback_x, CrouchLarge.knockback_y,
...
function LargeKick()
{
	...
	xspd = 0;
	yspd = 0;
	scrProcessAttacks(kickLargeSpr, sFighterKickHB, kickLarge.knockback_x, kickLarge.knockback_y,
